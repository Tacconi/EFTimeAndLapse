...
namespace EFTest
{
    ...
    public partial class PlayerConfiguration : EntityTypeConfiguration<Player>
    {
        ...
        public PlayerConfiguration(string schema)
        {
            ...
            Property(x => x.PlayerId).HasColumnName("PlayerID").IsRequired().HasColumnType("int").HasDatabaseGeneratedOption(DatabaseGeneratedOption.Identity);
            Property(x => x.RegistrationId).HasColumnName("RegistrationID").IsRequired().HasColumnType("int");
            Property(x => x.TeamId).HasColumnName("TeamID").IsRequired().HasColumnType("int");
            Property(x => x.CrewId).HasColumnName("CrewID").IsRequired().HasColumnType("int");
