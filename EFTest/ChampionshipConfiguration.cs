...
namespace EFTest
{
    ...
    public partial class ChampionshipConfiguration : EntityTypeConfiguration<Championship>
    {
        ...
        public ChampionshipConfiguration(string schema)
        {
            ...
            Property(x => x.ChampionshipId).HasColumnName("ChampionshipID").IsRequired().HasColumnType("int").HasDatabaseGeneratedOption(DatabaseGeneratedOption.Identity);
            Property(x => x.Name).HasColumnName("Name").IsRequired().HasColumnType("nvarchar").HasMaxLength(20);
            Property(x => x.Prize).HasColumnName("Prize").IsRequired().HasColumnType("nvarchar").HasMaxLength(40);
            InitializePartial();
        }
